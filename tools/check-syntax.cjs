...
for (const file of ['assets/account-library.js', 'assets/recommendations-core.js', 'assets/recommendations.js', 'assets/tracking-core.js', 'assets/tracking-pages.js', 'api/recommend.js']) {
